...
// Date:         2002-01-10
// Purpose:      Intel EP80219 PCI IO support macros
// Description: 
...
//-----------------------------------------------------------------------------
// Resources
#define _PCI_MEM_WINDOW		0x00000000
#define _PCI_IO_WINDOW		0x90000000
#define _PCI_MEM_BASE       	0x00000000
//#define _PCI_IO_BASE		0x00000000
...
#define __NIC  1  //Device gig-dev#
#define __SLOT 2

#define HAL_PCI_IGNORE_DEVICE(b, d, f) ep80219_ignore_device(b, d, f)
