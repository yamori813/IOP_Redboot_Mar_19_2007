...
// Date:         2001-12-03
// Purpose:      Intel XScale EP80219 platform specific support routines
// Description: 
...
#include <cyg/hal/ep80219.h>            // Platform specific hardware definitions
...
// FIXME FIXME FIXME FIXME FIXME FIXME FIXME FIXME FIXME 
	...
	ldr	r2, =PBLR_SZ_4K
	ldr	r1, =EP80219_UART_ADDR | PBAR_FLASH | PBAR_RCWAIT_20 | PBAR_ADWAIT_20 | PBAR_BUS_8
	str     r1, [r8, #0x10]  // PBIU_PBAR1
	str     r2, [r8, #0x14]  // PBIU_PBLR1

	ldr	r1, =EP80219_DISPLAY_RIGHT_ADDR | PBAR_FLASH | PBAR_RCWAIT_20 | PBAR_ADWAIT_20 | PBAR_BUS_8
	str     r1, [r8, #0x18]  // PBIU_PBAR2
	str     r2, [r8, #0x1C]  // PBIU_PBLR2

	ldr	r1, =EP80219_DISPLAY_LEFT_ADDR | PBAR_FLASH | PBAR_RCWAIT_20 | PBAR_ADWAIT_20 | PBAR_BUS_8
	str     r1, [r8, #0x20]  // PBIU_PBAR3
	str     r2, [r8, #0x24]  // PBIU_PBLR3

	ldr	r1, =EP80219_ROTARY_SWITCH_ADDR | PBAR_FLASH | PBAR_RCWAIT_20 | PBAR_ADWAIT_20 | PBAR_BUS_8
	str     r1, [r8, #0x28]  // PBIU_PBAR4
	str     r2, [r8, #0x2C]  // PBIU_PBLR4

	ldr	r1, =EP80219_COMPACTFLASH_ADDR | PBAR_FLASH | PBAR_RCWAIT_20 | PBAR_ADWAIT_20 | PBAR_BUS_16
	...
	ldr     r1, =EP80219_FLASH_ADDR | PBAR_FLASH | PBAR_RCWAIT_20 | PBAR_ADWAIT_20 | PBAR_BUS_16
	...
	ldr	r9, =EP80219_DISPLAY_RIGHT_ADDR
	ldr	r10,=EP80219_DISPLAY_LEFT_ADDR
	ldr	r11,=DISPLAY_F
