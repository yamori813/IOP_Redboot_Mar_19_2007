...
//      ep80219_misc.c
//
//      HAL misc board support code for Intel XScale EP80219
//
//==========================================================================
...
plf_hardware_init(void)
{
    ...
    *PIRSR = 0x0f;
    ...
    HAL_CACHE_SET_POLICY(SDRAM_UNCACHED_BASE,
                         (SDRAM_UNCACHED_BASE + SDRAM_MAX),
                         STALL);
...
bool ep80219_ignore_device(cyg_uint8 bus, cyg_uint8 dev,cyg_uint8 fn)
{
	//return 1;
	if ((bus == 0) && (dev == 0))
    	return 1;
