...
#include <cyg/hal/iq8033x.h>             // platform definitions
...
static channel_data_t plf_ser_channels[2] = {
    {
        (cyg_uint8*)IOP33X_UART0_ADDR,
        1000,
...
cyg_hal_plf_serial_init_channel(void* __ch_data)
{
    ...
    // Enable the UART function on the GPIO pins
