...
// Contributors: 
// Date:         2003-07-10
// Purpose:      Intel IQ80331/IQ80332 CRB Battery Diagnostics
...
battery_status(MENU_ARG arg)
{
    ...
    status = *IQ8033X_BATTERY_STATUS;

    // examine bit b0 BATT_PRES#
    if ((status & IQ8033X_BATTERY_PRESENT) == 0) {
...
{
    *IQ8033X_BATTERY_STATUS |= IQ8033X_BATTERY_ENABLE;
    if (*IQ8033X_BATTERY_STATUS & IQ8033X_BATTERY_ENABLE)
...
#endif // CYGSEM_HAL_ARM_IQ8033X_BATTERY_TEST
