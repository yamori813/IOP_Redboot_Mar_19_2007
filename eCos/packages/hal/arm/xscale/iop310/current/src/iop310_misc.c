...
#include <cyg/hal/hal_xscale_iop.h>     // IOP Common Hardware definitions
...
void _scrub_ecc(cyg_uint32 p)
{
    ...
    *IACR_REG = (iacr & IACR_RSV_MASK)   |
                IACR_PATU(IACR_PRI_OFF)  |
                IACR_SATU(IACR_PRI_OFF)  |
                IACR_DMA0(IACR_PRI_OFF)  |
	        IACR_DMA1(IACR_PRI_OFF)  |
 	        IACR_DMA2(IACR_PRI_OFF)  |
