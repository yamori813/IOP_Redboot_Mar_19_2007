...
#define iop310_is_host()        (hal_pci_cfg_flags & IOP310_PCI_MASTER)

#ifdef CYG_HAL_STARTUP_ROM
// Wait for BIOS to configure PCI.
...
#ifdef CYG_HAL_STARTUP_ROM
    if (((hal_pci_cfg_flags & IOP310_CONFIG_RETRY) == 0) || 
        ((hal_pci_cfg_flags & IOP310_PCI_MASTER) == IOP310_PCI_MASTER) || 
        !cyg_hal_plf_wait_for_bios())
    {
        // No configuration by a Host BIOS, take over Master role
        hal_pci_cfg_flags |= IOP310_PCI_MASTER;
    }
#endif
