...
#define ATU_PCIXSR_BUS_NUM(p)            (((p) >> 8) & 0xff)

#define PCI_OUTBOUND_MEM_WINDOW     0xA0000000
#define PCI_OUTBOUND_MEM_WINDOW_TOP 0xA8000000
#define PCI_OUTBOUND_IO_WINDOW      0xB0000000
#define PCI_OUTBOUND_IO_WINDOW_TOP  0xB0010000
...
#endif // CYGPKG_HAL_ARM_XSCALE_VERDE_IOP_FLAVOR
...
#ifdef CYGPKG_HAL_ARM_XSCALE_VERDE_IOP_FLAVOR_IOP321
#define IACR_RSV_MASK    0xFFFF030C
#else // CYGPKG_HAL_ARM_XSCALE_VERDE_IOP_FLAVOR_IOP321
#define IACR_RSV_MASK    0xFFFF330C
...
// --------------------------------------------------------------------------
// Software Flags
#define IOP321_CONFIG_RETRY     0x1
#define IOP321_DEV_HIDING       0x2
#define IOP321_PCI_MASTER       0x4
#define IOP321_PCI_PRIVMEM      0x8
