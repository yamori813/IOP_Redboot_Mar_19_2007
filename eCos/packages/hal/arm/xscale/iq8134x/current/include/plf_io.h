...
// Date:         2004-12-10
// Purpose:      Intel IQ8134 CRB PCI IO support macros
// Description: 
...
// 
#define __IQ8134X_PCI_SLOT_DEVNUM         1
#define __IQ8134X_GBE_DEVNUM              2
...
#define HAL_PCI_TRANSLATE_INTERRUPT( __bus, __devfn, __vec, __valid)           \
    ...
    cyg_uint32 __xbus;								\
    cyg_uint32 __onboard_gbe_devnum1;                                          \
    __onboard_gbe_devnum1 = __IQ8134X_GBE_DEVNUM;                              \
    __valid = false;                                                           \
  if(atux_safe())								\
	__xbus = iop34x_pcix_bus_number();                    			\
else										\
	__xbus = 0xFFFFFFFF;							\
    if ((__fn==0) &&                                                           \
        (__dev==__onboard_gbe_devnum1) && (__bus == __xbus))  {                \
...
{
#if defined(CYGSEM_HAL_ARM_IOP34X_32BIT_ECC_REGION_SIZE) && !defined(CYGSEM_HAL_ARM_IOP34X_32BIT_ECC_REGION_SIZE_0)
#define ECC32_HOLE_SIZE  (CYGSEM_HAL_ARM_IOP34X_32BIT_ECC_REGION_SIZE<<20)
...
#define ECC32_HOLE_TOP   (ECC32_HOLE_SIZE*2 + SDRAM_PHYS_BASE)
	...
	pa	-= CYGHWR_HAL_SDRAM_SPLIT_BASE;
#endif
...
{
    cyg_uint32 *ram_mmutab = (cyg_uint32*)(CYGARC_VIRTUAL_ADDRESS(_Read_Translation_Table_Base & 0xFFFFC000));
    cyg_uint32 pte;
