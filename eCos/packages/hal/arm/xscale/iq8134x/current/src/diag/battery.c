...
// Date:         2004-12-10
// Purpose:      Intel IQ8134 CRB Battery Diagnostics
//
//####DESCRIPTIONEND####
//
//===========================================================================*/
...
battery_status(MENU_ARG arg)
{
    ...
    status = *IQ8134X_BATTERY_STATUS;

    // examine bit b0 BATT_PRES#
    if ((status & IQ8134X_BATTERY_PRESENT) == 0) {
...
{
    *IQ8134X_BATTERY_STATUS |= IQ8134X_BATTERY_ENABLE;
    if (*IQ8134X_BATTERY_STATUS & IQ8134X_BATTERY_ENABLE)
...
#endif // CYGSEM_HAL_ARM_IQ8134X_BATTERY_TEST
