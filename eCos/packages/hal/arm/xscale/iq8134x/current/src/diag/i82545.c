...
ee_select( int ioaddr )
{
	...
	// Always set the REQ bit for 82545 - cebruns
    if (1) {
		l |= EE_REQ;
...
/* halfword addresses!  - original RedBoot defaults */
#if 1 
...
#else
/* LAD Defaults from HBA NIC */
/*  0: */  0x0400, 0xAA23, 0xB8D6, 0x0530,
/*  4: */  0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF,
/*  8: */  0xC486, 0x3702, 0x460B, 0x1002,
/*  C: */  0x8086, 0x1026, 0x8086, 0x34E8,
/* 10: */  0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF,
/* 14: */  0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF,
/* 18: */  0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF,
/* 1C: */  0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF,
/* 20: */  0xC30C, 0xFF63, 0x280C, 0x2102,
/* 24: */  0x00C8, 0xFFFF, 0xFFFF, 0xFFFF,
/* 28: */  0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF,
/* 2C: */  0xFFFF, 0xFFFF, 0xFFFF, 0x0602,
/* 30: */  0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF,
/* 34: */  0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF,
/* 38: */  0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF,
/* 3C: */  0xFFFF, 0xFFFF, 0xFFFF, 0xA4C8
#endif
};
...
enet_setup (MENU_ARG arg)
{
    ...
    cyg_uint32 onboard_gbe_devnum1, slot_devnum;

    int bus = iop34x_pcix_bus_number();
			
    onboard_gbe_devnum1 = __IQ8134X_GBE_DEVNUM;
    slot_devnum = __IQ8134X_PCI_SLOT_DEVNUM;
    ...
    if (!CYG_PCI_IGNORE_DEVICE(bus, onboard_gbe_devnum1, 0))
    {
        ...
        if ((dev_info.vendor == 0x8086) && ((dev_info.device == 0x1026) || \
            (dev_info.device == 0x1079))) {
    ...
    // Check the PCIe Slot
    //
	bus = iop34x_pcie_bus_number();
    if (!CYG_PCI_IGNORE_DEVICE(bus, 0, 0))
    {
        devid = CYG_PCI_DEV_MAKE_ID(bus, CYG_PCI_DEV_MAKE_DEVFN(slot_devnum, 0));
        cyg_pci_get_device_info(devid, &dev_info);
        if ((dev_info.vendor == 0x8086) && ((dev_info.device == 0x1026) || \
           (dev_info.device == 0x105e) || (dev_info.device == 0x105e))) {
            read_and_program_eeprom(&dev_info);
            return;
        }
    }
    ...
    // No Device Found
    //
    diag_printf("No i8254x device found\n");
    return;
}

#endif // CYGPKG_DEVS_ETH_INTEL_I82544 
