...
#include <cyg/hal/hal_ioc80314.h>         // registers
...
#define CYGNUM_HAL_VAR_ISR_MAX  33

#define CYGNUM_HAL_ISR_MIN      0
#define CYGNUM_HAL_ISR_MAX      33
...
#define HAL_PLATFORM_RESET()                                               \
    ...
    cyg_uint32 ctrl;                                                       \
                                                                           \
	if ((*(unsigned int*)(HAL_IOC80314_CSR_BASE+0x3038)) & 0x1)  {		   \
		diag_printf ("Sorry - can't Reset when Dual Enabled - hit the Reset switch\n"); \
		return;															\
	}																		\
	...
	/* Disable Watchdog, Put 80314 MMRs back to default location, Jump to reset vector */ \
	*(unsigned int*)(HAL_IOC80314_CSR_BASE + 0x3038) &= ~(0x4);  			\
	*(unsigned int*)(HAL_IOC80314_CSR_BASE + 0x3014) = (unsigned int)(HAL_80314_CSR_BASE | 0x1); \
	asm ("ldr pc, =0x40000000");											\
                                                                           \
