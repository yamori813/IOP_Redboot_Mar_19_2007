...
cyg_hal_plf_serial_init_channel(void* __ch_data)
{
    ...
    if (base == (cyg_uint32*)FFUART_BASE)
	*CLOCK_CKEN |= CKEN_FFUART;
    else if (base == (cyg_uint32*)BTUART_BASE)
	*CLOCK_CKEN |= CKEN_BTUART;
...
static channel_data_t plf_ser_channels[] = {
    { (cyg_uint32*)FFUART_BASE, 1000, CYGNUM_HAL_INTERRUPT_FFUART }
//    { (cyg_uint32*)BTUART_BASE, 1000, CYGNUM_HAL_INTERRUPT_BTUART }
//    { (cyg_uint32*)STUART_BASE, 1000, CYGNUM_HAL_INTERRUPT_STUART }
};
...
cyg_hal_plf_serial_init(void)
{
    ...
    for (i = 0; i < sizeof(plf_ser_channels)/sizeof(plf_ser_channels[0]); i++) {
