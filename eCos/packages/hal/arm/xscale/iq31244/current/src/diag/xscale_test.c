...
static MENU_ITEM testMenu[] =
{
    ...
    {"i82546 Ethernet Configuration", enet_setup, 0},
    {"i82546 Ethernet Test", enet_test, 0},
    {"Timer Test", timer_test, 0},
    {"LM75 Test", lm75_test, 0},
    {"PCI Bus test", pci_test, 0},
    {"Compact Flash Test", cf_test, 0},
    {"DMA Test", dma_test, 0},
	{"Intel 31244 (Artisea) Serial ATA Test", artisea_test, 0},
	{"Buzzer Test", BuzzerTest, 0},
...
rotary_switch (MENU_ARG arg)
{
    ...
    *(volatile unsigned char *)DISPLAY_RIGHT = DISPLAY_OFF;
	...
	do {
		...
		RotarySwitch[index] = *(volatile unsigned char *) IQ31244_ROTARY_SWITCH_ADDR;
