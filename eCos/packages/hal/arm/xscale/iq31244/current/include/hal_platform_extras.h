...
//
// Author(s):    msalter
// Contributors: msalter, dmosley
// Date:         2003-03-05
// Purpose:      Intel XScale IQ31244 platform specific mmu table
// Description: 
...
//===========================================================================*/
	...
	//    Set to uncached/buffered here in the flash-based page table for
	//    scrub loop performance (almost 2x speed using buffering)
	//    Will be changed to uncached/unbuffered once copied into RAM
	.set	__base,0xA00
	.rept	0xE00 - 0xC00
	FL_SECTION_ENTRY __base,0,3,1,0,0,1
	.set	__base,__base+1
	.endr
