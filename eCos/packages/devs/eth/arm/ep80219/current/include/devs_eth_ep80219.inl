//==========================================================================
//
//      devs/eth/arm/ep80219/include/devs_eth_arm_ep80219.inl
//
...
#ifdef CYGPKG_DEVS_ETH_ARM_EP80219_ETH0
...
#ifndef CYGSEM_DEVS_ETH_ARM_EP80219_ETH0_SET_ESA
...
#ifdef CYGSEM_DEVS_ETH_ARM_EP80219_ETH0_SET_ESA
    hardwired_esa: 1,
    mac_address: CYGDAT_DEVS_ETH_ARM_EP80219_ETH0_ESA
#else
    hardwired_esa: 0,
#endif
};
...
ETH_DRV_SC(i82559_sc0,
           ...
           CYGDAT_DEVS_ETH_ARM_EP80219_ETH0_NAME, // Name for device
           i82559_start,
           i82559_stop,
           i82559_ioctl,
           i82559_can_send,
...
NETDEVTAB_ENTRY(i82559_netdev0, 
                "i82559_" CYGDAT_DEVS_ETH_ARM_EP80219_ETH0_NAME,
                i82559_init, 
                &i82559_sc0);

#endif // CYGPKG_DEVS_ETH_ARM_EP80219_ETH0
