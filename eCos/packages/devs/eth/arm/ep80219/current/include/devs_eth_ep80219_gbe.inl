//==========================================================================
//
//      devs/eth/arm/ep80219/include/devs_eth_arm_ep80219_gbe.inl
//
//      EP80219 ethernet I/O definitions.
//
//==========================================================================
...
// Date:        2002-01-10
// Purpose:     EP80219 ethernet defintions
//####DESCRIPTIONEND####
//==========================================================================
...
#if defined(CYGPKG_DEVS_ETH_ARM_EP80219_I82544_ETH0) || defined(CYGPKG_DEVS_ETH_ARM_EP80219_I82544_ETH1)
...
#else
#define ACTIVE_PORTS CYGNUM_DEVS_ETH_INTEL_I82544_DEV_COUNT
#endif
...
#ifdef CYGPKG_DEVS_ETH_ARM_EP80219_I82544_ETH0

static I82544 i82544_eth0_priv_data = {
#ifdef CYGSEM_DEVS_ETH_ARM_EP80219_I82544_ETH0_SET_ESA
    hardwired_esa: 1,
    mac_address: CYGDAT_DEVS_ETH_ARM_EP80219_I82544_ETH0_ESA
#else
    hardwired_esa: 0,
#endif
};
...
ETH_DRV_SC(i82544_sc0,
           ...
           CYGDAT_DEVS_ETH_ARM_EP80219_I82544_ETH0_NAME, // Name for device
           i82544_start,
           i82544_stop,
           i82544_ioctl,
           i82544_can_send,
...
NETDEVTAB_ENTRY(i82544_netdev0,
                "i82541_" CYGDAT_DEVS_ETH_ARM_EP80219_I82544_ETH0_NAME,
                i82544_init,
                &i82544_sc0);

#endif // CYGPKG_DEVS_ETH_ARM_EP80219_I82544_ETH0
...
// EOF devs_eth_arm_ep80219_i82544.inl
