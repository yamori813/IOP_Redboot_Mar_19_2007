//==========================================================================
//
//      devs/eth/arm/iq8134x/include/devs_eth_arm_iq8134x.inl
//
//      IQ8134 CRB ethernet I/O definitions.
//
//==========================================================================
...
// Date:         2003-07-10
// Purpose:      IQ8134 CRB ethernet defintions
//####DESCRIPTIONEND####
//==========================================================================
...
#ifdef CYGPKG_DEVS_ETH_ARM_IQ8134X_I82544_ETH0
...
#ifdef CYGSEM_DEVS_ETH_ARM_IQ8134X_I82544_ETH0_SET_ESA
    hardwired_esa: 1,
    mac_address: CYGDAT_DEVS_ETH_ARM_IQ8134X_I82544_ETH0_ESA
#else
    hardwired_esa: 0,
#endif
};
...
ETH_DRV_SC(i82544_sc0,
           ...
           CYGDAT_DEVS_ETH_ARM_IQ8134X_I82544_ETH0_NAME, // Name for device
           i82544_start,
           i82544_stop,
           i82544_ioctl,
           i82544_can_send,
...
NETDEVTAB_ENTRY(i82544_netdev0, 
                "i82545_" CYGDAT_DEVS_ETH_ARM_IQ8134X_I82544_ETH0_NAME,
                i82544_init, 
                &i82544_sc0);

#endif // CYGPKG_DEVS_ETH_ARM_IQ8134X_I82544_ETH0
