...
externC int diag_copy_mem8_safe(cyg_uint8 *dst, cyg_uint8 *src, int count);
externC int diag_copy_mem16_safe(cyg_uint16 *dst, cyg_uint16 *src, int count);
externC int diag_copy_mem32_safe(cyg_uint32 *dst, cyg_uint32 *src, int count);
...
externC int  diag_sprintf(char *buf, const char *fmt, ...) CYGBLD_ATTRIB_PRINTF_FORMAT(2,3);
externC int  diag_snprintf(char *buf, size_t len, const char *fmt, ...) CYGBLD_ATTRIB_PRINTF_FORMAT(3,4);
externC int  diag_vsprintf(char *buf, const char *fmt, va_list ap) CYGBLD_ATTRIB_PRINTF_FORMAT(2,0);
externC int  diag_vprintf(const char *fmt, va_list ap) CYGBLD_ATTRIB_PRINTF_FORMAT(1,0);
