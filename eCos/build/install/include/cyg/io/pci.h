...
//----------------------------------------------------------------------
// Function to handle PCI alignment requirements
static inline CYG_PCI_ADDRESS64 cyg_pci_boundary_align(CYG_PCI_ADDRESS64 addr, cyg_uint32 bound)
{
    return ((addr + (bound - 1)) &~ (bound - 1));
}
...
#define CYG_PCI_MAX_BUS                      256  // Eight is enough?
#endif
